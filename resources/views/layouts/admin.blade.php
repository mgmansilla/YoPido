    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>YO</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>YOPido</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('/yopido/producto/index')}}"><i class="fa fa-circle-o"></i> Artículos</a></li>
                <li><a href="{{url('/yopido/categoria/index')}}"><i class="fa fa-circle-o"></i> Categorías</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('/yopido/pedido/index')}}"><i class="fa fa-circle-o"></i> Pedidos</a></li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de carga para APP</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="">Gabriela</a>.</strong> All rights reserved.
      </footer>
