                ...
                <div class="alert alert-success margen">
                    <div class="container-fluid">
                        ...
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <b>Perfecto:</b>{{ session('notification') }}<li><a href="https://www.dropbox.com/home/Aplicaciones/Yopido-Backups/Laravel" target="_blank"><i class="fa fa-dropbox"></i>Dropbox</a></li>
                    </div>
                </div>
            @endif
